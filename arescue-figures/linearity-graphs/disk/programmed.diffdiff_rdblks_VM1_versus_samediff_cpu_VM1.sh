export GP_FILETOPLOT="plot_diffdiff_VM1_rdblks_versus_samediff_VM1_cpu_rdonly-by-rate-lowrates-benchmark-final-metrics"
cut -d "," -f 10 rdonly-by-rate-lowrates-benchmark-final-metrics_diffdiff_VM1 > temp1
cut -d "," -f 2 rdonly-by-rate-lowrates-benchmark-final-metrics_samediff_VM1 > temp2
...
export GPFILENAME="diffdiff_VM1_rdblks_versus_samediff_VM1_cpu_rdonly-by-rate-lowrates-benchmark-final-metrics.eps"
