export GP_FILETOPLOT="plot_diffdiff_VM1_wrblks_versus_samediff_PM1_cpu_wronly-by-rate-lowrates-benchmark-final-metrics"
cut -d "," -f 11 wronly-by-rate-lowrates-benchmark-final-metrics_diffdiff_VM1 > temp1
cut -d "," -f 2 wronly-by-rate-lowrates-benchmark-final-metrics_samediff_PM1 > temp2
...
export GPFILENAME="diffdiff_VM1_wrblks_versus_samediff_PM1_cpu_wronly-by-rate-lowrates-benchmark-final-metrics.eps"
