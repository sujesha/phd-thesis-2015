...
export GPTITLE1="Colocated DomU CPU for disk read"
export GPTITLE2="Colocated DomU CPU for disk write"
export GPTITLE3="Colocated Dom0 CPU for disk read"
export GPTITLE4="Colocated Dom0 CPU for disk write"
