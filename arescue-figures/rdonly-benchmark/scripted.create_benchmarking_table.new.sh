...
for keyword in "rdonly-by-rate-lowrates"
do
	#Generated load
	...
	cut -d "," -f 10 "$keyword"-final-metrics_diffdiff_VM1 > firstVM_gen_actual
	cut -d "," -f 10 "$keyword"-final-metrics_diffdiff_VM2 > secondVM_gen_actual
