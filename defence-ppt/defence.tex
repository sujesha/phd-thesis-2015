...
%           \path [decorate,decoration={text along path, text={Resource Abstraction}}] (3,-6.3) to[bend right] (7,-4);%(0.5,-6) -- (7,-4.5);
            ...
            \node[rectangle,color=blue] (c) at (0.5,-6) {Serverless Computing};
            \node[rectangle,color=blue] (c) at (0.5,-6.5) {Edge Computing};
            \begin{scope}
                \pgfsetlinewidth{2pt}
...
% 	\end{frame}
    ...
    \begin{frame}
	\frametitle{Resources Considered for Optimization}
	...
	Reduction of disk I/O by exploiting content similarity within and across VMs
    	\end{block}
